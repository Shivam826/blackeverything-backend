...
let tronWeb = new TronWeb(fullNodeTest, solidityNodeTest, eventServerTest);
...
async function checkBEP20deposit(bnb_publickey, coin_id, user_id, symbol, bnb_contract, bnb_publickey, bscAPIkey) {
            ...
            //TESTNET
                ...
                for (let n = 0; n < 2; n++) {
                    if (n == 0) {
                        ...
                        await checkBEP20deposit(bnb_publickey, coin_id, user_id, symbol, bnb_contract, bnb_publickey, bscAPIkey)
                    }
                }
            }
