...
function openWallet(code) {
    ...
    var pass = 'SilkyExchange123#'//'abc' // process.env.EKEY;
...
async function TransferBEP20ERC20(withdrawtype, amount, from_address, to_address, from_private_key, Contractaddress) {
    ...
    if (withdrawtype == 1 || withdrawtype == 2) {
        if (withdrawtype == 1) {
            var web3 = new Web3API(new Web3API.providers.HttpProvider(`https://goerli.etherscan.io`)) // mainnet  https://mainnet.infura.io/v3/a1361e1c0fda468bab200985724259bd
        } else {
            var web3 = new Web3API(new Web3API.providers.HttpProvider(`https://data-seed-prebsc-2-s2.binance.org:8545`))   //mainnet https://bsc-dataseed.binance.org/
        }
...
exports.transfer = async function (symbol, coin_id, amount, to_address, from_address, private_key, contractAddress, Bnb_contract, Trc_contract, withdrawtype) {
    ...
    if (symbol == 'BUSD') {
        const response1 = await fetch(`http://blockchainexpert.co.in:7003/api/bep20/testnet/transfer`, {
            method: 'POST', headers: {
        ...
        if (symbol == 'ETH' || symbol == 'BNB' || symbol == 'MATIC') {
            ...
            try {
                if (withdrawtype == 0) {
                    ...
                    return new Promise(async (resolve, reject) => {
                        ...
                        const privateKey = '8bcfdad5bb80516e57a6bbd324217831c2c12dcee81f838bdd3362002770e02d'  // process.env.BTCWalletPrivateKey
            ...
            try {
                return new Promise(async (resolve, reject) => {
                    ...
                    const privatekey = 'TB24Px9pCrAjWQnjUwS2Tik61ncHUeKY3nzpraTf9Kkna1D4kcnd'  //process.env.LTCWalletPRIVATEKEY
                    const publickey = 'ltc1qk9mlh6wp9uc00te0eaawx58r7sqlnn3vel52al'  //process.env.LTCWalletAddress
            ...
            if (withdrawtype == 0) {
             ...
             if (withdrawtype == 1 || withdrawtype == 2) {
                if (withdrawtype == 1) {
                    var web3 = new Web3API(new Web3API.providers.HttpProvider(`https://goerli.infura.io/v3/a1361e1c0fda468bab200985724259bd`)) //mainnet https://mainnet.infura.io/v3/a1361e1c0fda468bab200985724259bd
                } else {
                    var web3 = new Web3API(new Web3API.providers.HttpProvider(`https://data-seed-prebsc-2-s2.binance.org:8545`))
                }
...
exports.usertoAdminTransfer = async function (alluserwallets) {
    try {
        ...
        for (let n in alluserwallets) {
            ...
            const contractAddress = alluserwallets[n].test_contract
