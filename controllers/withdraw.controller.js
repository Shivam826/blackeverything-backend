...
exports.userWithdraw = async (req, res) => {
    try {
        ...
        // req.body.tokenAmount = req.body.type==1 ? req.body.tokenAmount-((parseFloat(req.body.tokenAmount*settingData[0].deposit_fee)/100)).toFixed(2) :req.body.tokenAmount;       
