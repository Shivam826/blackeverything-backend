            ...
            if (getUsersEmail[0].password === hash) {
                ...
                // for (let n in coins) {
                    ...
                    if (wallets.length == 0) {
                        ...
                        if (wallet) {
                            var userwallet = {
                                ...
                                private_key: await encriptedKey(wallet.privateKey, "SilkyExchange123#"),//process.env.EKEY  //SilkyExchange123#
                                bnb_publickey: ETHwallet.address,
                                bnb_privatekey: await encriptedKey(ETHwallet.privateKey, "SilkyExchange123#"),//process.env.EKEY
                                trc_publickey: wallet.trc_publickey,
                                trc_privatekey: await encriptedKey(wallet.trc_privatekey, "SilkyExchange123#"),//process.env.EKEY
                                ip: null,
                                datetime: datetime
                            }
                        }
                    ...
                    if (wallets.length > 0 && (wallets[0].public_key == null || !wallets[0].public_key)) {
                        ...
                        var userwallet = {
                            public_key: wallet.public_key,
                            private_key: await encriptedKey(wallet.privateKey, "SilkyExchange123#"),//process.env.EKEY
                        }
                    ...
                    if (wallets.length > 0 && coins[n].Trc_contract !== null && (wallets[0].trc_publickey == null || wallets[0].trc_publickey == '' || !wallets[0].trc_publickey)) {
                        ...
                        var userwallet = {
                            ...
                            trc_privatekey: await encriptedKey(TRCwallet.privateKey, "SilkyExchange123#"), //process.env.EKEY
                        }
                        await UserModel.updateUserWallet(userwallet, getUsersEmail[0].id, coins[n].id);
                    }
